                          ...
                          <div className="d-flex flex-row flex-nowrap align-items-start">
                            ...
                            <div className="d-flex flex-fill flex-column">
                              ...
                              <div className="d-flex flex-row align-items-center">
                                <span className="mb-sm-0">Color: blue</span>
                                <span className="ml-2 mb-sm-0">Size: M</span>
                              </div>

                              <div className="d-flex flex-row justify-content-between align-items-center">
                                <p className="flex-fill text-start text-md-start mb-0">
                                  <strong>
                                ...
                                <div className="d-flex align-items-center" style={{ maxWidth: "300px" }} >
                                  ...
                                  <p className="mx-md-3 mb-0">{item.qty}</p>
